...
`documentation/2. design/todo.md` in the gateway repo, rows DSN-1698 and
DSN-1699, for the decision record and the open gaps this repo's first build
took a default position on.
